...
type CollisionEvent<T extends Draggable = Draggable, U extends Droppable = Droppable, V extends DragDropManager<T, U> = DragDropManager<T, U>> = DragDropEvents<T, U, V>['collision'];
type BeforeDragStartEvent<T extends Draggable = Draggable, U extends Droppable = Droppable, V extends DragDropManager<T, U> = DragDropManager<T, U>> = DragDropEvents<T, U, V>['beforedragstart'];
type DragStartEvent<T extends Draggable = Draggable, U extends Droppable = Droppable, V extends DragDropManager<T, U> = DragDropManager<T, U>> = DragDropEvents<T, U, V>['dragstart'];
type DragMoveEvent<T extends Draggable = Draggable, U extends Droppable = Droppable, V extends DragDropManager<T, U> = DragDropManager<T, U>> = DragDropEvents<T, U, V>['dragmove'];
type DragOverEvent<T extends Draggable = Draggable, U extends Droppable = Droppable, V extends DragDropManager<T, U> = DragDropManager<T, U>> = DragDropEvents<T, U, V>['dragover'];
type DragEndEvent<T extends Draggable = Draggable, U extends Droppable = Droppable, V extends DragDropManager<T, U> = DragDropManager<T, U>> = DragDropEvents<T, U, V>['dragend'];
/**
 ...
 */
declare function resolveCustomizable<T>(value: Customizable<T> | undefined, defaults: T): T;
...
export { ActivationConstraint, type ActivationConstraints, ActivationController, type BeforeDragStartEvent, type Collision, type CollisionDetector, type CollisionEvent, CollisionPriority, CollisionType, CorePlugin, type Customizable, type Data, DragActions, type DragDropEvents, DragDropManager, type DragDropManagerInput, type DragEndEvent, type DragMoveEvent, type DragOperationSnapshot as DragOperation, Status as DragOperationStatus, type DragOverEvent, type DragStartEvent, Draggable, type Input$1 as DraggableInput, Droppable, type Input as DroppableInput, Entity, Modifier, type ModifierConstructor, type Modifiers, Plugin, type PluginConstructor, type PluginDescriptor, type PluginOptions, PluginRegistry, type Plugins, type Renderer, Sensor, type SensorConstructor, type SensorDescriptor, type SensorOptions, type Sensors, type Type, type UniqueIdentifier, configurator, configure, descriptor, resolveCustomizable, sortCollisions };
